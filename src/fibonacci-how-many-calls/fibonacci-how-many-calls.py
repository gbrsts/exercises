...
# One way of finding Fibonacci numbers is by recursive calls. This is illustrated below, presenting the tree of derivation when we calculate fib(4),
# i.e. the fifth value of this sequence:
...
# Output
# For each test case we will have an output line, in the following format: fib(n) = num_calls calls = result, where num_calls is the number of recursive calls, 
# always with a space before and after the equal sign, as shown below.
