...
# The lengths of the available blocks are {a1; a2; ...;  aN} and wished length by the artist is M. 
# The block with length = 1 is widely used, for this reason he always appears in the list of available blocks. 
# Your task is to find the minimum number of blocks such that the sum of their lengths is M.
